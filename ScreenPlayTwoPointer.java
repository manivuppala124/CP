 ...
 */
import java.util.*;
  public class ScreenPlayTwoPointer {
      public static int refill(int[] a,int n,int c1,int c2){
          int ca=c1,cb=c2,l=0,r=n-1,count=0;
          while(l<=r){
              if(ca<a[l]){
                  ca=c1;
                  count++;
      ...
      public static void main(String[] args){
          ...
          System.out.println(refill(a,n,c1,c2));
          scan.close();
      }
  }